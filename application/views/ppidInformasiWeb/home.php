...
<div class="box">
  ...
  <div class="col-md-2">
      <button class="form-control btn btn-primary" data-toggle="modal" data-target="#tambah-informasiWeb"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Data</button>
  </div>
    <div class="col-md-2">
...
<?php echo $modal_tambah_informasiWeb;?>

<div id="tempat-modal"></div>

<?php
  $data['judul'] = 'Laporan';
  $data['url'] = 'PpidInformasiWeb/export';
  echo show_my_modal('modals/modal_exportInfoWeb', 'export-data', $data);
?>
