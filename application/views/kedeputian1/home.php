...
<div class="box">
  ...
  <div class="col-md-2">
      <button class="form-control btn btn-primary" data-toggle="modal" data-target="#tambah-kedeputian1"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Data</button>
  </div>
    <div class="col-md-2">
...
<?php echo $modal_tambah_kedeputian1;?>

<div id="tempat-modal"></div>

<?php
  $data['judul'] = 'Laporan';
  $data['url'] = 'Kedeputian1/export';
  echo show_my_modal('modals/modal_exportKedeputian1', 'export-data', $data);
?>
