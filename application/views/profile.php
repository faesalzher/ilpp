  ...
  <div class="col-md-3">
    ...
    <div class="box box-primary">
      <div class="box-body box-profile">
        ...
        <h3 class="profile-username text-center"><?php echo $userdata->nama_pengguna; ?></h3>
        ...
        <div class="active tab-pane" id="settings">
          <form class="form-horizontal" action="<?php echo base_url('Profile/update') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Name" name="nama_pengguna" value="<?php echo $userdata->nama_pengguna; ?>">
              </div>
            </div>
            <div class="form-group">
